...
(function () {
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='http://connexus-recall.youre.space:5002/mt-static/images/indicator.white.gif' alt='Loading' />";
  ...
  function _updateComments() {
    ...
    cacheKey = [direction, entryID, commentsPerPage, offset]
        ...
        .replace(/[^a-zA-Z0-9-]/g, '');
    jsonUrl  = [
        "http://connexus-recall.youre.space:5002/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'http://connexus-recall.youre.space:5002/mt-comments.cgi?__mode=userinfo&blog_id=2&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
        (document.getElementsByTagName('head'))[0].appendChild(script);
    }
}
...
function mtVerifySession(cb) {
    ...
    var ts = new Date().getTime();
    var u = mtGetUser();
    script.src = 'http://connexus-recall.youre.space:5002/mt-comments.cgi?__mode=verify_session&blog_id=2&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
    (document.getElementsByTagName('head'))[0].appendChild(script);
}
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '71c90135e86a8131e3915e7af46d63ef1e476a1c';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=http%3A%2F%2Fconnexus.youre.space%2Fmt7%2F';
        }
    } else {
