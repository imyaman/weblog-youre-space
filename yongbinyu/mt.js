...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=userinfo&blog_id=9&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
        (document.getElementsByTagName('head'))[0].appendChild(script);
    }
}
...
function mtVerifySession(cb) {
    ...
    var ts = new Date().getTime();
    var u = mtGetUser();
    script.src = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=verify_session&blog_id=9&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
    (document.getElementsByTagName('head'))[0].appendChild(script);
}
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = '99081718fb4e52fef90f3a107245f0a2856b7248';
...
function mtSignIn() {
    ...
    var url = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=login&blog_id=9';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=https%3A%2F%2Fweblog.youre.space%2Fyongbinyu%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=handle_sign_in&static=0&logout=1&blog_id=9';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
