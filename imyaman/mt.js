...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=userinfo&blog_id=12&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
        (document.getElementsByTagName('head'))[0].appendChild(script);
    }
}
...
function mtVerifySession(cb) {
    ...
    var ts = new Date().getTime();
    var u = mtGetUser();
    script.src = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=verify_session&blog_id=12&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
    (document.getElementsByTagName('head'))[0].appendChild(script);
}
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'd9537c704be6439570f320d289d8a0cbc2ec6d60';
...
function mtSignIn() {
    ...
    var url = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=login&blog_id=12';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
        } else {
            url += '&return_url=https%3A%2F%2Fweblog.youre.space%2Fimyaman%2F';
        }
    } else {
...
function mtSignOut(entry_id) {
    ...
    var doc_url = document.URL;
    doc_url = doc_url.replace(/#.+/, '');
    var url = 'https://connexus.youre.space/mt6/mt-comments.cgi?__mode=handle_sign_in&static=0&logout=1&blog_id=12';
    if (is_preview) {
        if ( document['comments_form'] ) {
            var entry_id = document['comments_form'].entry_id.value;
            url += '&entry_id=' + entry_id;
